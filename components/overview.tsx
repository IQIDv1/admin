  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Agent activity over the last {timeRange === '24h' ? '24 hours' : 'week'}
        </CardDescription>
        <Tabs value={timeRange} onValueChange={setTimeRange}>
          <TabsList>
            <TabsTrigger value="24h" className="text-primary hover:bg-purple/10">
              Last 24 Hours
            </TabsTrigger>
            <TabsTrigger value="week" className="text-primary hover:bg-purple/10">
              Last Week
            </TabsTrigger>
          </TabsList>
        </Tabs>
