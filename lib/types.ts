...
export type OrganizationInboundMessagesActivity = Database["public"]["Tables"]["organization_inbound_messages_activity"]["Row"];
...
export type OrganizationOutboundMessagesActivity = Database["public"]["Tables"]["organization_outbound_messages_activity"]["Row"];
